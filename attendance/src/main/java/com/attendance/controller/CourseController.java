...
public class CourseController {
	...
	public ResponseEntity<ResponseDTO> updateCourse(@RequestBody Course course, @PathVariable("id") Long id) {
		try {
	...
	public ResponseEntity<ResponseDTO> findBypK(@PathVariable("id") Long id) {
		try {
